        ...
        if(data) {
            ...
            switch(page) {
                ...
                case "crew": 
                    ...
                    Elements.CrewSelection().pic.addEventListener("click",()=> {
                        if(Storage.GetCurrentCrewMem() < 3) {
                            Storage.SetCurrentCrewMem(Number(Storage.GetCurrentCrewMem())+1);
                        } else {
                            Storage.SetCurrentCrewMem(0);
                        }
                        this.LoadPage("crew");
